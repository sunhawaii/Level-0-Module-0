...
if __name__ == '__main__':
    ...
    adj=simpledialog.askstring(title='Greeter', prompt="Enter a adjective.")
    ...
    simpledialog.askstring(title='Greeter', prompt="Piranhas are more " + adj + " during the day, so cross the river at\n"
